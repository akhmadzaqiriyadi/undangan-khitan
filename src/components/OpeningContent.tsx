        ...
        >
          ...
          >
            ...
            <motion.div className="mb-6" variants={itemVariants}>
              <p className="font-arabic text-lg text-darkBrown mb-2">
                بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيم
              </p>
              <p className="text-sm text-darkBrown/80 italic">
            ...
            <motion.h1
              className="font-display text-4xl font-bold mb-6 text-yellow-700 tracking-wider"
              variants={itemVariants}
            >
              KHITAN
            </motion.h1>
